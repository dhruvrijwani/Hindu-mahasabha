          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex-shrink-0 flex items-center">
              <Link to="/" className="flex items-center gap-3">
                <div className="w-10 h-10 bg-saffron-500 rounded-full flex items-center justify-center text-white font-display font-bold text-xl">
                  HM
                </div>
                <div className="flex flex-col">
                  <span className="font-display font-bold text-lg md:text-xl leading-tight text-navy-900">
                    Akhil Bharatiya
                  </span>
                  <span className="font-display font-bold text-lg md:text-xl leading-tight text-navy-900">
                    Hindu Mahasabha
      ...
      <footer className="bg-saffron-50 text-navy-900 pt-16 pb-8 border-t border-saffron-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-12">
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 bg-saffron-500 rounded-full flex items-center justify-center text-white font-display font-bold text-xl drop-shadow-sm">
                  HM
                </div>
                <div className="flex flex-col">
                  <span className="font-display font-bold text-lg leading-tight text-navy-900">Akhil Bharatiya</span>
                  <span className="font-display font-bold text-lg leading-tight text-navy-900">Hindu Mahasabha</span>
                </div>
              </div>
          ...
          <div className="pt-8 border-t border-saffron-200 text-sm text-gray-500 flex flex-col md:flex-row justify-between items-center gap-4">
            <p>&copy; {currentYear} Akhil Bharatiya Hindu Mahasabha. All Rights Reserved.</p>
